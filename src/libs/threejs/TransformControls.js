...
THREE.TransformControlsGizmo = function () {
    ...
    matGreen.color.set(COLORS.GREEN);

    var matBlue = gizmoMaterial.clone();
    matBlue.color.set(COLORS.BLUE);
    ...
    matLineRed.color.set(COLORS.RED);

    var matLineGreen = gizmoLineMaterial.clone();
    matLineGreen.color.set(COLORS.GREEN);

    var matLineBlue = gizmoLineMaterial.clone();
    matLineBlue.color.set(COLORS.BLUE);
    ...
    this.updateMatrixWorld = function () {
        ...
        for (var i = 0; i < handles.length; i++) {
            ...
            if (this.mode === 'translate') {
                ...
                switch (handle.name) {
                    case 'X': {
                        scale = this.boundingBoxMesh._width;
                        break;
                    }
                    case 'Y': {
                        scale = this.boundingBoxMesh._depth;
                        break;
                    }
                    case 'Z': {
                        scale = this.boundingBoxMesh._height;
                        break;
                    }
                }
