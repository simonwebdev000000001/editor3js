...
GUtils.onEventPrevent = (event, shouldStopPropogation, shouldPrevent = false) => {
...
GUtils.XMLtoHTNL = (stringXML) => {
  let tempDiv = document.createElement('div');
  tempDiv.innerHTML = stringXML;
  return tempDiv.children[0];
};

GUtils.getPointInBetweenByPerc = (pointA, pointB, percentage = 0.5) => {
